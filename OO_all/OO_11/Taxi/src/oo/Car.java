...
out_it();
	...
	Map.subflow(nextx,nexty,3-dir,-2);
		...
		int min_flow=(int) 1e9;
				if (Map.getg()[spec][x][y] == 2 || Map.getg()[spec][x][y] == 3){//Car Down
				...
				if (Map.getg()[spec][x][y] == 1 || Map.getg()[spec][x][y] == 3){//Car Right
				...
				if (y-1>=1&&Map.getg()[spec][x][y-1] == 1 || Map.getg()[spec][x][y-1] == 3){//Car Left
				...
				if (x-1>=1&&Map.getg()[spec][x-1][y] == 2 || Map.getg()[spec][x-1][y] == 3){//Car Up 
